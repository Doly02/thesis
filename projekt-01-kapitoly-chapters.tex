...
V tomto případě je kapacita kondenzátoru~$C = \SI{0.33}{\farad}$ a odpor~$R = \SI{10}{\ohm}$, což dává časovou konstantu~$\tau = \SI{3.3}{\second}$. Platí, že po uplynutí pěti časových konstant ($5\tau$) se kondenzátor nabije přibližně na 99~\% napětí kondenzátoru. To v případě zálohovaného napájení znamená, že plné nabití kondenzátoru proběhne zhruba za  $t = 16.5$ sekundy.

Při návrhu zálohovaného napájení je třeba zohlednit maximální nabíjecí proud nejen s ohledem na vlastnosti samotného kondenzátoru, ale i s ohledem na způsob, jakým bude záznamník standardně napájen, jelikož nabíjení zmíněného kondenzátoru bude mít velký vliv na maximální odběr proudu. Například zmíněný Power Profiler 2 zvládne poskytnout až \SI{1}{\ampere}, USB-C naopak dle standardu zvládne minimálně \SI{3}{\ampere}. Maximální nabíjecí proud do kondenzátoru je při počátečním napětí kondenzátoru blízkém nule dán Ohmovým zákonem jako:

\begin{equation}
    I = \frac{V}{R} \label{eq:ohms_law_current}
\end{equation}

\begin{figure}[h]
    \centering
    \includegraphics[width=1.00\textwidth]{obrazky-figures/backup-power.png}

...
Navržený digitální záznamník je koncipován jako modulární a~dále rozšiřitelný systém, který lze v~budoucnu snadno doplnit o~nové funkce či upraven pro záznam jiných typů dat podle potřeb konkrétní aplikace.

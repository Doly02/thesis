...
\begin{figure}[h]
    ...
    \caption{Oblasti souborového systému FAT \cite{arduino_shop_due}}
    \label{fig:fatfs-structure}
\end{figure}

% Jaky je rozdil mezi FAT32 a FATFS?
V dnešní době existuje několik variant systému FAT, mezi nejznámější patří FAT12, FAT16, FAT32 a exFAT. Pro úložná média typu SDHC karet se obvykle volí FAT32, neboť nižší varianty, jakou je třeba FAT16, omezuje maximální kapacitu úložného média pouze na 4 GB, což je pro dnešní aplikace často nedostatečné. Z tohoto důvodu i dnešní implementace FATFS podporují 32bitovou či 64bitovou variantu, které podporují mnohem větší kapacitu uložišť.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{obrazky-figures/fat_file_system_bigger.png}
    
    \caption{Souborový systém s alokační tabulkou souborů \cite{arduino_shop_due}}

...
Na následujícím obrázku \ref{fig:test-capacitors}, pořízeném z osciloskopu, je možné vidět výsledek výše zmíněného testu, ze kterého vyplývá, že doba mezi intervaly počínaje hodnotou 4.6V po 3.5V odpovídá vhodnosti parametrů, čímž bylo ověřeno, že kondenzátor je vhodný pro využití v zálohovaném napájení.

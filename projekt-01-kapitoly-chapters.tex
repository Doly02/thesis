...
Tato úloha využívá mnoho konceptů představených v kapitole \ref{klicove_koncepty_digitalnich_zaznamniku} mezi které patří vícenásobná vyrovnávací paměť, dávkové zpracování a cirkulární buffer, data jsou získávána z periferie LP\_FLEXCOMM, která je nakonfigurována v režimu UART a jsou přímo v oblužné rutině vkládány do cirkulární vyrovnávací paměti neboli FIFO fronty.

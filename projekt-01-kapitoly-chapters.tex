...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|c|c|X|}
        ...
        \hline
        \texttt{DEFAULT\_PARITY} & Žádná & Výchozí nastavení parity – parita není používána. \\
        \hline
        ...
        \hline
    \end{tabularx}
    \caption{Výchozí hodnoty používané při absenci nebo chybě v konfiguračním souboru}

...
Obvod reálného času oproti běžnému časovači udržuje absolutní čas a dokáže jej udržovat dlouhodobě aktuální hodnotu času, a to i při přerušení napájení, pokud je RTC vybaveno záložním napájením (například pomocí knoflíkové baterie).

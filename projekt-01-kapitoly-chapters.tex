...
Zapojení obsahuje dioda, konktétně schottky dioda, na které vzniká úbytek napětí - na té konkrétně použíté 0.4V. 
Zde je třeba si vysvětlit pár základních skutečností obvodu, zde je přítomna  Dále je třeba či vlastností desky FRDM-MCXN947, která bude napájená z výše popsaného kondenzátoru. Vstupní napětí 5V jde přes LDO, které upravuje napětí na 3V3 zásobující čip
